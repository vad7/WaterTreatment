...
struct type_option {
	...
	uint16_t DrainPumpPowerMax;		// Максимальная мощность дренажного насоса после времени старта, Вт
	uint8_t  DrainPumpPowerMaxStartTime;// Время старта дренажного насоса, с
};

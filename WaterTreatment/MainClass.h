...
uint8_t  TankLeakageTimer = 255;	// sec
...
uint8_t  DrainingSiltFlag = 1;	// 0 - идет слив, 1 - нет/ожидание, 2 - проверка на герметичность
...
struct type_option {
	...
	uint8_t  TankLeakagePercent;	// Проверка на утечку бака, тревога, если уровень уменьшится без потребителей на %
};

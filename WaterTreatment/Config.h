...
//	#define TANK_EMPTY			8        // Емкость пуста (INP6)
   ...
   // Исполнительные устройства (реле и сухие контакты) ------------------------------------------------------------------
	...
	#define PIN_LED_SRV_INFO_NEXT_REGEN_PULSE 100UL // Длительность вспышки светодиода при запланированной регенерации
	#define PIN_LED_SRV_INFO_NEXT_REGEN_PAUSE 3000UL // Длительность паузы светодиода при запланированной регенерации

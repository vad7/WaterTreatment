...
//	#define TANK_EMPTY			8        // Емкость пуста (INP6)
   ...
   // Исполнительные устройства (реле и сухие контакты) ------------------------------------------------------------------
	...
	#define PWATER_OSMOS_WATERBOOSTER_MAX_MUL	8	// Множитель максимального объема бака насосной станции, меньше 1 - увеличение реагента, больше 1 - уменьшение, десятые

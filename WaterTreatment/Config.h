...
//	#define TANK_EMPTY			8        // Емкость пуста (INP6)
   ...
   // Исполнительные устройства (реле и сухие контакты) ------------------------------------------------------------------
	...
	#define RWATEROFF1				3	// Реле перекрывающего крана после фильтра 1
	#define RDRAIN					4	// Реле слива после обезжелезивателя
	#define RDRAIN2					5	// Реле слива после умягчителя
	#define RFILL					6	// Реле заполнения бака
    // устройства DC 5..24V
	#define RSTARTREG				7	// Реле старта регенерации обезжелезивателя (белый+/зеленый-)
	#define RSTARTREG2				8	// Реле старта регенерации умягчителя (белый+/оранжевый-)
	#define RWATERON				9	// Реле открывающего крана после всех фильтров

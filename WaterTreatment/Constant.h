...
#define W5500_LINK_CHECK  30				// Периодичность контроля соединения, сек
...
#endif
#define TIME_WEB_SERVER       2              // мсек. Период опроса web_server()
...
#define WEB0_OTHER_FUNC_PERIOD 10            // Период выполнения других функция в задаче Web0, сек
...
const char *option_SepticMinMaxPowerTime= {"SWT"};
...
const char *noteError[] = {
		...
		"Мало израсходовано воды при сбросе (когда долго не было расхода)",					//-52
		...
		"Две регенерации в одно и тоже время",												//-71
